...
export type GetTasksQuery = { tasks: Array<{ __typename: 'Task', id: string, title: string, description: string | null, completed: boolean }> };
...
export type CompleteTaskMutation = { completeTask: { __typename: 'Task', id: string } | null };
